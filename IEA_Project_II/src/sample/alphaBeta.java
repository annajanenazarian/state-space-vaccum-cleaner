                ...
                timer.schedule(new TimerTask() {
                    ...
                    public void run() {
                        ...
                        for (int j = 0; j < cleanAgentX.size(); j++) {
                            if ((getDownC(j) == 4) || (getDownC(j) == 2))
                                moveCleanAgent1(cleanAgentX.get(j), 0, cleanAgentY.get(j), 1);
                            else if ((getRightC(j) == 4) || (getRightC(j) == 2))
                                moveCleanAgent1(cleanAgentX.get(j), 1, cleanAgentY.get(j), 0);
                            else if ((getUpC(j) == 4) || (getUpC(j) == 2))
                                moveCleanAgent1(cleanAgentX.get(j), 0, cleanAgentY.get(j), -1);
                            else if ((getLeftC(j) == 4) || (getLeftC(j) == 2))
                                moveCleanAgent1(cleanAgentX.get(j), -1, cleanAgentY.get(j), 0);
                            else {
